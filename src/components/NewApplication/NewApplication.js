      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="radio-btn-container">
          <input
            ...
            className="radio-btn"
          />
          <label className="form-label">National</label><br />
        </div>
        <div className="radio-btn-container">
          <input
            type="radio"
            ...
            className="radio-btn"
          />
          <label className="form-label">International</label><br />
        </div>
        ...
        <div className="radio-btn-container">
          <input
            ...
            id="conference-reg"
          />
          <label className="form-label">Conference Registration/Publication Support</label><br />
        </div>
        <div className="radio-btn-container">
          <input
            type="radio"
            ...
            id="conference-pub"
          />
          <label className="form-label">Cash Award for Conference Publication</label><br />
        </div>
        <div className="radio-btn-container">
          <input
            type="radio"
            ...
            id="journal-pub"
          />
          <label className="form-label">Cash Award for Journal Publication</label><br />
        </div>
        <div className="radio-btn-container">
          <input
            type="radio"
            ...
            id="book-chp-pub"
          />
          <label className="form-label">Cash Award for Book Chapter</label><br />
        </div>
        <div className="radio-btn-container">
          <input
            type="radio"
            ...
            id="book"
          />
          <label className="form-label">Cash Award for Book</label><br />
        </div>
